    ...
    <section id="story" className="py-16 sm:py-20 lg:py-28 bg-white font-montserrat border-b border-slate-200/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 font-montserrat">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center font-montserrat">
          ...
          {/* LEFT: Cinematic Image Composition (Sharp Square Corners, No Badge) */}
          <div data-reveal="left" className="lg:col-span-6 relative">
            <div className="group relative rounded-none overflow-hidden shadow-[0_20px_50px_rgba(15,23,42,0.12)] border border-slate-200/90 bg-slate-950 transition-all duration-700">
              ...
              <div className="cinematic-image-wrapper relative overflow-hidden aspect-[4/3] sm:aspect-[16/11]">
                {/* CAD Corner Brackets */}
          ...
          <div data-reveal="right" className="lg:col-span-6 space-y-6 font-montserrat">
            ...
            {/* Sub-headline / Narrative Paragraphs */}
            <div className="space-y-3 font-montserrat max-w-xl">
            ...
            {/* Feature List */}
            <div className="gsap-stagger-list border-y border-slate-200/90 divide-y divide-slate-200/90 font-montserrat py-1">
              {highlights.map((item) => (
                <div key={item} className="gsap-stagger-item group py-3.5 flex items-center justify-between gap-4 font-montserrat cursor-default">
                  ...
                  <CheckCircle2 className="h-5 w-5 text-[#0062CD] shrink-0" />
                </div>
              ))}
            </div>

            {/* 3-Column Stats Strip */}
            <div className="grid grid-cols-3 divide-x divide-slate-200 border border-slate-200/90 rounded-none bg-slate-50/70 p-3.5 sm:p-4 text-center font-montserrat">
              {displayStats.map((stat) => (
                <div key={stat.label} className="px-2 font-montserrat">
                  <span className="text-lg sm:text-2xl font-bold text-slate-900 block leading-tight font-montserrat">
                    {stat.value}
                  </span>
                  <span className="text-[10px] sm:text-xs font-semibold uppercase tracking-wider text-slate-500 mt-1 block font-montserrat">
                    {stat.label}
                  </span>
                </div>
              ))}
            ...
            <div className="pt-2">
              <Link
                to="/about"
                className="group inline-flex items-center gap-3 bg-[#0062CD] text-white px-8 py-3.5 sm:py-4 rounded-lg font-bold text-xs uppercase tracking-widest hover:bg-[#0052b0] transition-all duration-300 shadow-lg shadow-[#0062CD]/20 hover:shadow-[#0062CD]/35 hover:-translate-y-0.5 active:scale-95 cursor-pointer font-montserrat"
              >
