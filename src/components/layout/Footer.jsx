      ...
      <div data-reveal="up" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 space-y-4 font-montserrat">
            <Link to="/" className="flex items-center gap-3 font-montserrat">
              ...
              <div className="flex flex-col font-montserrat">
                ...
                <span className="text-[10px] font-montserrat tracking-widest text-slate-400 uppercase font-bold">
          ...
          <div className="font-montserrat">
            ...
            <ul className="space-y-2.5 text-xs sm:text-sm font-montserrat text-slate-300">
              <li><Link to="/" className="hover:text-[#3894FF] transition-colors font-montserrat">Home</Link></li>
              <li><Link to="/services" className="hover:text-[#3894FF] transition-colors font-montserrat">Services</Link></li>
              <li><Link to="/capabilities" className="hover:text-[#3894FF] transition-colors font-montserrat">Capabilities</Link></li>
              <li><Link to="/solutions" className="hover:text-[#3894FF] transition-colors font-montserrat">Solutions</Link></li>
              <li><Link to="/careers" className="hover:text-[#3894FF] transition-colors font-montserrat">Careers</Link></li>
            </ul>
          </div>
          ...
          <div className="font-montserrat">
            ...
            <ul className="space-y-2.5 text-xs sm:text-sm font-montserrat text-slate-300">
              <li><Link to="/services" className="hover:text-[#3894FF] transition-colors font-montserrat">Product Engineering</Link></li>
              <li><Link to="/capabilities" className="hover:text-[#3894FF] transition-colors font-montserrat">Web Development</Link></li>
              <li><Link to="/solutions" className="hover:text-[#3894FF] transition-colors font-montserrat">AI &amp; RAG Workflows</Link></li>
              <li><Link to="/services" className="hover:text-[#3894FF] transition-colors font-montserrat">Mobile Application</Link></li>
              <li><Link to="/about" className="hover:text-[#3894FF] transition-colors font-montserrat">About Our Team</Link></li>
            </ul>
          </div>
          ...
          <div className="font-montserrat">
            ...
            <ul className="space-y-3 text-xs sm:text-sm font-montserrat text-slate-300">
              <li className="flex items-center gap-2.5 font-montserrat">
                ...
                <a href={`mailto:${CONTACT_EMAIL}`} className="hover:text-[#3894FF] transition-colors font-montserrat">{CONTACT_EMAIL}</a>
              </li>
              <li className="flex items-center gap-2.5 font-montserrat">
                <Phone className="h-4 w-4 text-slate-500 shrink-0" />
                <span className="hover:text-[#3894FF] transition-colors font-montserrat">{CONTACT_PHONE}</span>
              </li>
              <li className="flex items-start gap-2.5 font-montserrat">
                <MapPin className="h-4 w-4 text-slate-500 shrink-0 mt-0.5" />
                <span className="hover:text-[#3894FF] transition-colors font-montserrat">{OFFICE_ADDRESS}</span>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-slate-900 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-montserrat text-slate-500">
          ...
          <div className="flex items-center gap-6 font-montserrat">
            <span className="hover:text-[#3894FF] cursor-pointer transition-colors font-montserrat">Privacy Policy</span>
            <span className="hover:text-[#3894FF] cursor-pointer transition-colors font-montserrat">Terms of Service</span>
            <span className="hover:text-[#3894FF] cursor-pointer transition-colors font-montserrat">Security SLA</span>
          </div>
        </div>
      </div>
    </footer>
