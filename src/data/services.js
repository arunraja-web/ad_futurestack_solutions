export const services = [
  ...
  },
  {
    ...
    description:
      'Node.js, Express, Java Spring Boot, and Python microservices engineered for high throughput and zero downtime.',
    image: '/images/capabilities/microservices.webp',
    deliverables: ['REST & GraphQL APIs', 'Auth & Security', 'Stripe Billing', 'Third-Party Webhooks'],
  },
  {
    id: 'mobile-engineering',
    layer: 'Mobile Platforms',
  ...
  },
  {
    ...
    description:
      'Automated Docker containers, Kubernetes clusters, and AWS/GCP CI/CD pipelines so deploys are instant and safe.',
    image: '/images/capabilities/cloud-devops.webp',
    deliverables: ['AWS / GCP Setup', 'Docker & K8s', 'GitHub Actions CI/CD', 'Telemetry & Alerting'],
  },
  {
    id: 'saas-architecture',
    layer: 'SaaS Architecture',
